...
\begin{figure}[t]
\begin{center}
\epsfig{file=watchpoints.eps, width=2.9in, height=1.1in}
\end{center}
...
\begin{figure}
%\subfloat{
\epsfig{file=watchpoint.eps,width=2.9in}
 %}
