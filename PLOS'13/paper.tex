...
\begin{figure*}[ht!]
\centering
\subfloat[(a) Policy Switching Protocol]{
...
\hfill
 \subfloat[(b) Uninstrumented Code]{\usebox\asmbox}
\hfill
 \subfloat[(c) Instrumented Basic Blocks]{
