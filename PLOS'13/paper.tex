...
\end{tikzpicture}
%\begin{program}
%\PROC P_{after\_entry}::F_{module} \BODY
%  \FOR |each instruction|\ I\ |in a basic block|
%    \IF I\ |is a call instruction| 
%       \THEN Policy(I) \gets P_{call\_entry}
%     \ELSE Policy(I) \gets P_{after\_entry}
%\end{program}
%\vspace{-2em}
%\begin{program}
%\PROC P_{call\_entry}::F_{module} \BODY
%  \FOR |each instruction|\ I\ |in a basic block|
%    Policy(I) \gets P_{after\_entry}
%\end{program}
\columnbreak
