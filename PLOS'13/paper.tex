...
%This section evaluates Granary using the \texttt{iozone} file system benchmark to exercise the \texttt{ext3} and \texttt{jbd} file system and journaling kernel modules.
