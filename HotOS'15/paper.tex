...
The remainder of this section explains how we vary the detection granularity (\Secref{proxymem}), how we use sampling
to detect contending accesses to shared memory (\Secref{heapsample}), how we reduce false negatives with our
sampling-based approach (\Secref{falsenegs}), and finally how we rank discovered instances of false sharing (\Secref{ranking})
