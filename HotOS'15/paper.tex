...
%\begin{enumerate}
%\item Detecting what code is important to the 
%\end{enumerate}
%
%analyzing
%the 
%
%the detection
%of what code should be instrumented and what data should be sampled is \emph{not} time-sensitive, and
%therefore can be performed any time. 
%
%using results gathered from
%an offline learning and analysis phase. This separation is motivated by recognizing that 
