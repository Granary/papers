...
Unlike most DBT frameworks, Granary includes \texttt{call} instructions into basic blocks, which exposes code cache addresses to instrumented module code in the form of return addresses. The benefit of including \texttt{call} instructions is better return-address prediction by the processor and longer basic blocks, which provide more code visibility to instrumentation tools at instrumentation time.
