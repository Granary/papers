...
The reported data can be re-integrated into Granary to drive profile-guided optimizations, or post-processed into a format for use by tools like KCacheGrind for profile data visualization.
