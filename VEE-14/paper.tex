...
\begin{table*}[ht!]
\scriptsize
\begin{tabularx}{\linewidth}{| l | >{\raggedright}m{0.3\linewidth} | X |}
\hline
\bf Name & \bf Description & \bf Example Tool \\
\hline
...
\hline
Module-only & All code from a specific kernel module or driver is instrumented. Granary detaches when module code invokes kernel code, and re-attaches when kernel code invokes module code. All non-module kernel code executes with zero overhead. & TODO \\
\hline
Probe-based & All code within a particular function is instrumented. Granary attaches when the function is invoked, and detaches when the function returns or invokes another function. & TODO \\
\hline
\end{tabularx}
